...
static const char *funny_messages[][2] = {
	{"WE RECHARTED TARGET PRACTICE", "NOW SHUT UP"},
	{"BALLISTIC PARTS ARE ALL VOLUMES FAULT", "WE GET IT"},
	{"LUCIA SEQUEL", "COMING SOON"},
	{"WE GOT INTO FUNKY FRIDAY", "LETS GOOOOO"},
	{"EVEN MORE FNF", "IS COOL"},
	{"A LOT OF DOWNLOADS", "THANK YOU ALL"},
	{"TOP TEXT", "BOTTOM TEXT"},
	{"HOW TO ADD WHITTY CUTSCENE", "VISPLOO WAS HERE"},
	{"CHECK AND THE MONKEY FANS", "UNIFIED BEATS IS COOL"},
	{"THIS STARTED AS A JOKE", "WE ARE SO SORRY"},
	{"BEACH BROTHER X SANS PREGNANT", "NO CONTEXT"},
	{"AUDIO JUNGLE", "AA EE OO"},
	{"THE BEES AND THE BIRDS", "ALL OVER AGAIN"},
	{"OLD TARGET PRACTICE", "SKILL ISSUE"},
	{"SKILL ISSUE", "CRY ABOUT IT"},
	{"BOOPEEBO EASY TOO HARD", "HOW TO BEAT"},
	{"FNF FREE DOWNLOAD", "MEDIAFIRE"},
	{"WHY DO I HAVE TO PAY", "ITCH.IO NOT FREE"},
	{"IM NOT THE CREATOR OF MATT", "NINTENDO HELP"},
	{"SUS", "AMOGUS"},
	{"TRAINING IS OVER", "SKILL ISSUE ALL OVER AGAIN"},
	{"FNF", "FIVE NIGHTS FREDDYS"},
	{"SHOUTOUTS TO BBPANZU", "NEVER REPLIED MY DMS"},
	{"OBAMA BE LIKE", "YO MICHELLE LOOK AT THIS COOL MOD"},
	{"GET REAL", "THAT'S IT"},
	{"THE MAGIC SCHOOL BUS", "ATTACKED BY PICO"},
	{"KADE ENGINE MOMENT", "SPAM IF YOU WANT"},
	{"RETROSPECTER", "WHERES THE MATT REMIX"},
	{"RETURN TO MONKE", "REJECT HUMANITY"},
	{"THERES A VERY LOW CHANCE", "YOULL SEE THIS ONE"},
	{"WE COULDNT UPDATE KADE ENGINE", "I HATE GITHUB"},
	{"AVERAGE UPSCROLL FAN", "AVERGA DOWNSCROLL ENJOYER"},
	{"GOOD NIGHT NIGHT", "ILL SEE YOU TOMORROW"},
	{"SHOTUOUTS TO BEEZY", "I LOVE YOUR ART"},
	{"WE DO A LITTLE TROLLING", "AMOGUS BSIDE REMIX"},
	{"AND TROLLS", "DONT GET BLOCKED"},
	{"19 DOLLAR FORTNITE CARD", "AND YES IM GIVING IT AWAY"},
	{"BRITISH", "INNIT MATE"},
	{"CORE MOD COMING SOON", "I PROMISE"},
	{"SHOUTOUTS TO SKETCHY", "COOL IDEA"},
	{"LAMP OIL ROPE OR BOMBS", "AS LONG AS YOU HAVE RUPEES"},
	{"3AM MCDONALDS", "AMOGUS HAPPY MEAL"},
	{"SOMEWHERE IN NEVADA", "WHERE THE STADIUM ALSO IS"},
	...
	switch (exec_page = menu.page)
	{
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//junk
					case 2:
						menu.font_bold.draw(&menu.font_bold, "MODDERFUNKERS",    SCREEN_WIDTH2, SCREEN_HEIGHT2 - 48, FontAlign_Center);
						Gfx_BlitTex(&menu.tex_ng, &src_ng, (SCREEN_WIDTH - 128) >> 1, SCREEN_HEIGHT2 - 16);
					case 1:
						menu.font_bold.draw(&menu.font_bold, "A MOD BY", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 64, FontAlign_Center);
					break;
				//junk
					case 5:
						menu.font_bold.draw(&menu.font_bold, "UNSTOPABLE", SCREEN_WIDTH2, SCREEN_HEIGHT2 + 6, FontAlign_Center);
					case 4:
						menu.font_bold.draw(&menu.font_bold, "MATTPSX",   SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "MATTS TUESDAY SINGING LESSONS", {"LIGHT IT UP", "RUCKUS", "TARGET PRACTICE"}},
				{"2", StageId_2_1, "MATT IS DONE", {"SPORTING", "BOXING MATCH", ""}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				//{StageId_4_4, "TEST"},
				{StageId_1_1, "LIGHT IT UP"},
				{StageId_1_2, "RUCKUS"},
				{StageId_1_3, "TARGET PRACTICE"},
				{StageId_2_1, "SPORTING"},
				{StageId_2_2, "BOXING MATCH"},
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Clwn_2, "	OG MATT MOD", false},
				{StageId_Clwn_2, "SULAYRE", false},
				{StageId_Clwn_2, "HAYLEY CONTROL", false},
				{StageId_Clwn_2, "THEONLYVOLUME", false},
				{StageId_Clwn_2, "BIDDLE", false},
				{StageId_Clwn_2, "JOAN ATLAS", false},
				{StageId_Clwn_2, "MILAN", false},
				{StageId_Clwn_2, "WHIPPYORC", false},
				{StageId_Clwn_2, "DEAD SKULLXX", false},
				{StageId_Clwn_2, "JAMS THREE D", false},
				{StageId_Clwn_2, "PACIOFD", false},
				{StageId_Clwn_2, "BEEZYLOVE", false},
				{StageId_Clwn_2, "HEXERRUSH", false},
				{StageId_Clwn_2, "LETTER Y", false},
				{StageId_Clwn_1, "	THE ENTIRE PORT", false},
